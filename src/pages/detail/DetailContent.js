...
function DetailContent(){
    ...
    <div className={cx('wrapper')}>
        ...
        <p>Located in the real heart of Krakow. This property has excellent location score of 9.8!</p>   
        <p>${data.nine_night_price}<span>(9 nights)</span></p> 
        <button className={cx('button')}>Reserve or Book Now!</button>   
            </div>
        </div>
    </div>
